...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, expected_response: Dict,
        ...
        Args:
            ...
            expected_response (Dict): Expected response from the org method.
            mocked_function (MagicMock): Mock for the get_json function.
        """
    ...
    def test_public_repos(self, mock_get_json: MagicMock) -> None:
        ...
        Args:
            mock_get_json (MagicMock): Mock for the get_json function.
        """
        test_payload = {
            'repos_url': "https://api.github.com/users/google/repos",
            'repos': [
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """Integration tests for GithubOrgClient using real payloads."""

    @classmethod
    def setUpClass(cls) -> None:
        """Set up mocks for requests.get for all tests in the class."""
        route_payload = {
    ...
    def test_public_repos(self) -> None:
        """Test the public_repos method with mocked API response."""
        self.assertEqual(
            GithubOrgClient("google").public_repos(),
            self.expected_repos,
        )
    ...
    def test_public_repos_with_license(self) -> None:
        """Test the public_repos method filtered by license type."""
        self.assertEqual(
